...
from webforces.server.structs import DBStatus, ERROR_ID, Language, User, Algorithm, Test, Task
...
class DBTest(TestCase):
    ...
    def test_can_add_diff_algs(self):
        ...
        alg2 = Algorithm(0, "TITLE_ALG2", "DESCR_ALG2", user1.user_id, "SOURCE_ALG2", [], Language.lang_cpp, 0)
        alg3 = Algorithm(0, "TITLE_ALG3", "DESCR_ALG3", user2.user_id, "SOURCE_ALG3", [], Language.lang_cpp, 0)
    ...
    def test_cant_add_alg_with_incorrect_user_id(self):
        ...
        alg = Algorithm(0, "TITLE_ALG", "DESCR_ALG", user.user_id + len("typo"), "SOURCE_ALG", [], Language.lang_cpp, 0)
    ...
    def test_cant_add_iden_algs(self):
        ...
        _, user2 = (self.core.db.addUser(user2))
        alg1 = Algorithm(0, "TITLE_ALG1", "DESCR_ALG1", user1.user_id, "SOURCE_ALG1", [], Language.lang_cpp, 0)
        alg2 = Algorithm(0, "TITLE_ALG1", "DESCR_ALG2", user1.user_id, "SOURCE_ALG2", [], Language.lang_cpp, 0)
        alg3 = Algorithm(0, "TITLE_ALG1", "DESCR_ALG3", user2.user_id, "SOURCE_ALG3", [], Language.lang_cpp, 0)
        status1, alg1 = self.core.db.addAlg(alg1)
        status2, alg2 = self.core.db.addAlg(alg2)
        status3, alg3 = self.core.db.addAlg(alg3)
        self.assertEqual(status1, DBStatus.s_ok)
    ...
    def test_can_get_alg_by_correct_title(self):
        user = User(0, "LOGIN_USER", "FN_USER", "SN_USER", "MN_USER", [], [])
        _, user = (self.core.db.addUser(user))
        alg1 = Algorithm(0, "TITLE_ALG1", "DESCR_ALG1", user.user_id, "SOURCE_ALG1", [], Language.lang_cpp, 0)
    ...
    def test_can_add_diff_tests(self):
        ...
        _, alg2 = (self.core.db.addAlg(alg2))
        _, alg3 = (self.core.db.addAlg(alg3))
        test1 = Test(0, alg1.alg_id, "TITLE_TEST1", "INPUT_TEST1", "OUTPUT_TEST1")
        test2 = Test(0, alg1.alg_id, "TITLE_TEST2", "INPUT_TEST2", "OUTPUT_TEST2")
        test3 = Test(0, alg2.alg_id, "TITLE_TEST3", "INPUT_TEST3", "OUTPUT_TEST3")
        test4 = Test(0, alg3.alg_id, "TITLE_TEST4", "INPUT_TEST4", "OUTPUT_TEST4")
    ...
    def test_cant_add_iden_tests(self):
        user = User(0, "LOGIN_USER", "FN_USER", "SN_USER", "MN_USER", [], [])
        _, user = (self.core.db.addUser(user))
        alg = Algorithm(0, "TITLE_ALG", "DESCR_ALG", user.user_id, "SOURCE_ALG", [], Language.lang_cpp, 0)
        _, alg = (self.core.db.addAlg(alg))
        test1 = Test(0, alg.alg_id, "TITLE_TEST1", "INPUT_TEST1", "OUTPUT_TEST1")
        test2 = Test(0, alg.alg_id, "TITLE_TEST1", "INPUT_TEST2", "OUTPUT_TEST2")
        status1, test1 = self.core.db.addTest(test1)
        status2, test2 = self.core.db.addTest(test2)
        self.assertEqual(status1, DBStatus.s_ok)
        self.assertEqual(status2, DBStatus.s_data_issue)
    ...
    def test_cant_add_test_with_incorrect_alg_id(self):
        ...
        alg = Algorithm(0, "TITLE_ALG", "DESCR_ALG", user.user_id, "SOURCE_ALG", [], Language.lang_cpp, 0)
        _, alg = (self.core.db.addAlg(alg))
        test = Test(0, alg.alg_id + len("typo"), "TITLE_TEST", "INPUT_TEST", "OUTPUT_TEST")
    ...
    def test_cant_get_test_by_incorrect_ids(self):
        ...
        _, alg2 = (self.core.db.addAlg(alg2))
        _, alg3 = (self.core.db.addAlg(alg3))
        test1 = Test(0, alg1.alg_id + len("typo"), "TITLE_TEST1", "INPUT_TEST1", "OUTPUT_TEST1")
        test2 = Test(0, alg1.alg_id + len("typo"), "TITLE_TEST2", "INPUT_TEST2", "OUTPUT_TEST2")
        test3 = Test(0, alg2.alg_id + len("typo"), "TITLE_TEST3", "INPUT_TEST3", "OUTPUT_TEST3")
        test4 = Test(0, alg3.alg_id + len("typo"), "TITLE_TEST4", "INPUT_TEST4", "OUTPUT_TEST4")
        _, test1 = (self.core.db.addTest(test1))
        _, test2 = (self.core.db.addTest(test2))
        _, test3 = (self.core.db.addTest(test3))
        _, test4 = (self.core.db.addTest(test4))
    ...
    def test_cant_add_alg_with_negative_cost(self):
        user = User(0, "LOGIN_USER", "FN_USER", "SN_USER", "MN_USER", [], [])
        _, user = self.core.db.addUser(user)
        alg = Algorithm(0, "TITLE_ALG", "DESCR_ALG", user.user_id, "SOURCE_ALG", [], Language.lang_cpp, -100)
        st, alg = self.core.db.addAlg(alg)
        self.assertEqual(st, DBStatus.s_data_issue)
        self.assertEqual(self.core.db._getNextID("1a"), DBStatus.s_data_issue)

    def test_cant_add_alg_with_incorrect_lang_id(self):
        user = User(0, "LOGIN_USER", "FN_USER", "SN_USER", "MN_USER", [], [])
        _, user = self.core.db.addUser(user)
        alg = Algorithm(0, "TITLE_ALG", "DESCR_ALG", user.user_id, "SOURCE_ALG", [], Language.lang_unknown, -100)
        st, alg = self.core.db.addAlg(alg)
        self.assertEqual(st, DBStatus.s_data_issue)
        self.assertEqual(self.core.db._getNextID("1a"), DBStatus.s_data_issue)
    ...
    def test_can_get_all_algs_with_flags(self):
        ...
        _, user3 = self.core.db.addUser(user3)
        alg1 = Algorithm(0, "TITLE_ALG1", "DESCR_ALG1", user1.user_id, "SOURCE_ALG1", [], Language.lang_cpp, 0)
        alg2 = Algorithm(0, "TITLE_ALG2", "DESCR_ALG2", user1.user_id, "SOURCE_ALG2", [], Language.lang_cpp, 100)
        alg3 = Algorithm(0, "TITLE_ALG3", "DESCR_ALG3", user2.user_id, "SOURCE_ALG3", [], Language.lang_cpp, 0)
        alg4 = Algorithm(0, "TITLE_ALG4", "DESCR_ALG4", user3.user_id, "SOURCE_ALG4", [], Language.lang_cpp, 100)
        _, alg1 = self.core.db.addAlg(alg1)
        _, alg2 = self.core.db.addAlg(alg2)
        _, alg3 = self.core.db.addAlg(alg3)
    ...
    def test_can_get_all_bound_algs_by_correct_user_id(self):
        user1 = User(0, "LOGIN_USER1", "FN_USER1", "SN_USER1", "MN_USER1", [], [])
        user2 = User(0, "LOGIN_USER2", "FN_USER2", "SN_USER2", "MN_USER2", [], [])
        _, user1 = (self.core.db.addUser(user1))
        _, user2 = (self.core.db.addUser(user2))
        alg1 = Algorithm(0, "TITLE_ALG1", "DESCR_ALG1", user1.user_id, "SOURCE_ALG1", [], Language.lang_cpp, 0)
        alg2 = Algorithm(0, "TITLE_ALG2", "DESCR_ALG2", user1.user_id, "SOURCE_ALG2", [], Language.lang_cpp, 0)
        alg3 = Algorithm(0, "TITLE_ALG3", "DESCR_ALG3", user1.user_id, "SOURCE_ALG3", [], Language.lang_cpp, 0)
        _, alg1 = (self.core.db.addAlg(alg1))
        _, alg2 = (self.core.db.addAlg(alg2))
        _, alg3 = (self.core.db.addAlg(alg3))
        user2.bound_ids = [alg1.alg_id, alg2.alg_id, alg3.alg_id]
        self.core.db.bindAlg(user2)
        status1, algs1 = self.core.db.getAllBoundAlgs(user1.user_id)
        status2, algs2 = self.core.db.getAllBoundAlgs(user2.user_id)
        self.assertEqual(status1, DBStatus.s_ok)
        self.assertEqual(status2, DBStatus.s_ok)
        self.assertEqual(algs1, [])
        self.assertEqual(algs2[0], alg1)
        self.assertEqual(algs2[1], alg2)
        self.assertEqual(algs2[2], alg3)

    def test_cant_get_all_bound_algs_by_incorrect_user_id(self):
        user1 = User(0, "LOGIN_USER1", "FN_USER1", "SN_USER1", "MN_USER1", [], [])
        user2 = User(0, "LOGIN_USER2", "FN_USER2", "SN_USER2", "MN_USER2", [], [])
        _, user1 = (self.core.db.addUser(user1))
        _, user2 = (self.core.db.addUser(user2))
        ...
        user2.bound_ids = [alg1.alg_id, alg2.alg_id, alg3.alg_id]
        self.core.db.bindAlg(user2)
        status1, algs1 = self.core.db.getAllBoundAlgs(user1.user_id + len("typo"))
        status2, algs2 = self.core.db.getAllBoundAlgs(user2.user_id + len("typo"))
        self.assertEqual(status1, DBStatus.s_data_issue)
        self.assertEqual(status2, DBStatus.s_data_issue)
        self.assertEqual(algs1, [Algorithm(ERROR_ID)])
        self.assertEqual(algs2, [Algorithm(ERROR_ID)])

    def test_can_check_if_free_algorithm_is_available_for_user(self):
        user = User(0, "LOGIN_USER", "FN_USER", "SN_USER", "MN_USER", [], [])
        _, user = (self.core.db.addUser(user))
        alg = Algorithm(0, "TITLE_ALG", "DESCR_ALG", user.user_id, "SOURCE_ALG", [], Language.lang_cpp, 0)
        _, alg = (self.core.db.addAlg(alg))
        status, is_available = self.core.db.checkAvailable(user.user_id, alg.alg_id)
        self.assertEqual(status, DBStatus.s_ok)
        self.assertTrue(is_available)

    def test_can_check_if_algorithm_is_available_for_author(self):
        user1 = User(0, "LOGIN_USER1", "FN_USER1", "SN_USER1", "MN_USER1", [], [])
        user2 = User(0, "LOGIN_USER2", "FN_USER2", "SN_USER2", "MN_USER2", [], [])
        _, user1 = (self.core.db.addUser(user1))
        _, user2 = (self.core.db.addUser(user2))
        alg = Algorithm(0, "TITLE_ALG", "DESCR_ALG", user1.user_id, "SOURCE_ALG", [], Language.lang_cpp, 5)
        _, alg = (self.core.db.addAlg(alg))
        status, is_available = self.core.db.checkAvailable(user1.user_id, alg.alg_id)
        self.assertEqual(status, DBStatus.s_ok)
        self.assertTrue(is_available)
        status, is_available = self.core.db.checkAvailable(user2.user_id, alg.alg_id)
        self.assertEqual(status, DBStatus.s_ok)
        self.assertFalse(is_available)

    def test_can_check_if_bound_algorithm_is_available_for_user(self):
        user1 = User(0, "LOGIN_USER1", "FN_USER1", "SN_USER1", "MN_USER1", [], [])
        user2 = User(0, "LOGIN_USER2", "FN_USER2", "SN_USER2", "MN_USER2", [], [])
        user3 = User(0, "LOGIN_USER3", "FN_USER3", "SN_USER3", "MN_USER3", [], [])
        _, user1 = (self.core.db.addUser(user1))
        ...
        self.assertEqual(status, DBStatus.s_ok)
        self.assertTrue(is_available)
        status, is_available = self.core.db.checkAvailable(user3.user_id, alg.alg_id)
        self.assertEqual(status, DBStatus.s_ok)
        self.assertFalse(is_available)

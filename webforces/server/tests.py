...
class DBTest(TestCase):
    ...
    def test_can_add_diff_algs(self):
        ...
        _, user1 = (self.core.db.addUser(user1))
        _, user2 = (self.core.db.addUser(user2))
        alg1 = Algorithm(0, "TITLE_ALG1", "DESCR_ALG1", user1.user_id, "SOURCE_ALG1", [], 0)
        alg2 = Algorithm(0, "TITLE_ALG2", "DESCR_ALG2", user1.user_id, "SOURCE_ALG2", [], 0)
        alg3 = Algorithm(0, "TITLE_ALG3", "DESCR_ALG3", user2.user_id, "SOURCE_ALG3", [], 0)
    ...
    def test_cant_add_alg_with_incorrect_user_id(self):
        ...
        alg = Algorithm(0, "TITLE_ALG", "DESCR_ALG", user.user_id + len("typo"), "SOURCE_ALG", [], 0)
    ...
    def test_cant_add_iden_algs(self):
        ...
        _, user2 = (self.core.db.addUser(user2))
        alg1 = Algorithm(0, "TITLE_ALG1", "DESCR_ALG1", user1.user_id, "SOURCE_ALG1", [], 0)
        alg2 = Algorithm(0, "TITLE_ALG1", "DESCR_ALG2", user1.user_id, "SOURCE_ALG2", [], 0)
        alg3 = Algorithm(0, "TITLE_ALG1", "DESCR_ALG3", user2.user_id, "SOURCE_ALG3", [], 0)
        status1, alg1 = self.core.db.addAlg(alg1)
        status2, alg2 = self.core.db.addAlg(alg2)
        status3, alg3 = self.core.db.addAlg(alg3)
        self.assertEqual(status1, DBStatus.s_ok)
    ...
    def test_can_get_alg_by_correct_title(self):
        user = User(0, "LOGIN_USER", "FN_USER", "SN_USER", "MN_USER", [])
        _, user = (self.core.db.addUser(user))
        alg1 = Algorithm(0, "TITLE_ALG1", "DESCR_ALG1", user.user_id, "SOURCE_ALG1", [], 0)
    ...
    def test_cant_add_iden_tests(self):
        user = User(0, "LOGIN_USER", "FN_USER", "SN_USER", "MN_USER", [])
        _, user = (self.core.db.addUser(user))
        alg = Algorithm(0, "TITLE_ALG", "DESCR_ALG", user.user_id, "SOURCE_ALG", [], 0)
